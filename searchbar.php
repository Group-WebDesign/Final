...
<html lang="en">
  ...
  <body>
	...
	$input = "SELECT id, title, category, creatorid FROM `mcdoncam-db`.`Thread` WHERE title LIKE '%$searchtag%'";		$query = mysqli_query($conn, $sql);
	$query = mysqli_query($conn, $input) or die(mysqli_error($conn));
	echo "<table align='left'>";
	echo "<tr><th align='justify'>Title</th><th align='justify'>Category</th><th align='justify'>User</th></tr>";
    ...
    echo "&nbsp &nbsp &nbsp";
		echo "<td align='justify'>". $result["creatorid"] . "</td>";
		echo "</tr>";
	}
	echo "</table>";
	echo "<br></br>";
